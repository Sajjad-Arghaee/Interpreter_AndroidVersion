package project.interpreter.Core;

import java.io.*;

public class Reader {

    public static Int intData = new Int();
     ...
     * @throws InvalidForException in case of problems which caused by for statement
     */
    public static StringBuilder read(String Data) throws InvalidForException{
        try {
    ...
    public static void readStatement(BufferedReader reader) throws InvalidForException, IOException {
